...
export default function LandingPage() {
  ...
  const go = () =>
    router.push(
      query.trim() ? `/home?q=${encodeURIComponent(query)}` : "/home"
    );
  ...
  return (
    <div
      className="min-h-screen bg-[#f8fafc] text-slate-900 overflow-x-hidden"
    ...
    >
          ...
          <div className="hidden md:flex items-center gap-3">
            {user ? (
              <div className="relative">
                ...
                {dropOpen && (
                  <div
                    className="absolute right-0 top-11 bg-white border border-slate-100 rounded-2xl shadow-2xl shadow-slate-200/60 p-1.5 w-48 z-50"
                  ...
                  >
                    {[
                      ...
                      <button
                        ...
                        className="w-full text-left px-3 py-2.5 text-sm hover:bg-slate-50 rounded-xl text-slate-700 font-medium transition-colors"
                      >
                        {label}
                      </button>
                    ))}
              ...
              <>
                ...
                <button
                  ...
                  className="text-sm bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-xl font-semibold transition-all hover:shadow-lg hover:shadow-blue-200 active:scale-95"
                >
                  Get Started
                </button>
              </>
      ...
      {mobileMenu && (
        <div className="fixed inset-0 z-[200] flex">
          ...
          <div className="relative ml-auto w-72 bg-white h-full flex flex-col p-6 gap-2 shadow-2xl">
            <button
              onClick={() => setMobileMenu(false)}
              className="self-end mb-3 p-1.5 hover:bg-slate-100 rounded-lg"
            >
              <X size={18} className="text-slate-500" />
            </button>
            {user && (
              <div className="bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-100 rounded-2xl p-4 mb-2">
                <p className="text-[10px] text-blue-400 uppercase tracking-wider mb-0.5 font-semibold">
                  Signed in as
                </p>
            ...
            {[
              ...
              .map(({ label, path }) => (
                <button
                  ...
                  className="text-left px-4 py-3 rounded-xl text-sm font-medium hover:bg-slate-50 text-slate-700 transition-colors"
                >
                  {label}
                </button>
              ))}
            {user ? (
              ...
              <div className="flex flex-col gap-2 mt-2">
                <button
                  ...
                  className="px-4 py-3 rounded-xl text-sm font-semibold border border-slate-200 hover:bg-slate-50"
                >
                  Sign In
                </button>
                <button
                  ...
                  className="px-4 py-3 rounded-xl text-sm font-semibold bg-blue-600 text-white hover:bg-blue-700"
                >
                  Get Started
                </button>
              </div>
      ...
      >
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-5 sm:px-8 py-20 grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            {/* Headline */}
            <h1
              className={`text-[2.75rem] sm:text-5xl lg:text-[3.5rem] font-black leading-[1.08] tracking-tight mb-6 ${reveal(
                mounted,
                80
              )}`}
            >
            ...
            <p
              className={`text-slate-500 text-lg leading-relaxed mb-9 max-w-md ${reveal(
                mounted,
                160
              )}`}
            >
          ...
          {/* Right — image */}
          <div
            className={`relative hidden lg:block transition-all duration-1000 delay-[200ms] ${
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {FEATURES.map((f, i) => {
              ...
              return (
                <div
                  key={f.title}
                  className={`group bg-white border border-slate-200 rounded-2xl p-7 hover:border-blue-200 hover:shadow-xl hover:shadow-blue-50/80 hover:-translate-y-1 transition-all duration-300 ${reveal(
                    featInView,
                    i * 80
                  )}`}
                >
          ...
          <div className="grid grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
            {CITIES.map((c, i) => (
              <button
                ...
                className={`relative rounded-2xl overflow-hidden aspect-[3/4] group cursor-pointer text-left transition-all duration-700 hover:-translate-y-1 delay-[${
                  (i % 3) * 80
                }ms] ${
          ...
          <div className="grid sm:grid-cols-3 gap-5">
            {[
              ...
              return (
                <div
                  key={s.n}
                  className="bg-white border border-slate-200 rounded-2xl p-8 text-left hover:border-blue-200 hover:shadow-xl hover:shadow-blue-50/80 hover:-translate-y-1 transition-all duration-300 group"
                >
        ...
        <div className="max-w-6xl mx-auto px-5 sm:px-8">
          ...
          <div className="grid sm:grid-cols-3 gap-4">
            {TESTIMONIALS.map((t, i) => (
              <div
                key={t.name}
                className={`bg-white border border-slate-200 rounded-2xl p-6 hover:border-blue-200 hover:shadow-xl hover:shadow-blue-50/60 hover:-translate-y-1 transition-all duration-500 delay-[${
                  i * 100
                }ms] ${
                  testInView
                    ? "opacity-100 translate-y-0"
              ...
              >
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="text-4xl text-blue-100 font-serif leading-none select-none">
                    &ldquo;
                  </span>
                </div>
      ...
      >
        ...
        <div className="relative z-10 max-w-2xl mx-auto px-5 sm:px-8">
          <span
            className={`inline-block text-xs font-bold text-blue-200 uppercase tracking-widest border border-blue-400/40 bg-white/10 backdrop-blur-sm px-4 py-1.5 rounded-full mb-6 transition-all duration-700 ${
              ctaInView
                ? "opacity-100 translate-y-0"
          ...
          <h2
            className={`text-4xl sm:text-5xl font-black text-white leading-tight mb-5 transition-all duration-700 delay-100 ${
              ctaInView
                ? "opacity-100 translate-y-0"
                : "opacity-0 translate-y-5"
            }`}
          ...
          <p
            className={`text-blue-200 text-base mb-10 max-w-md mx-auto leading-relaxed transition-all duration-700 delay-200 ${
              ctaInView
                ? "opacity-100 translate-y-0"
                : "opacity-0 translate-y-5"
            }`}
          ...
          <div
            className={`flex gap-3 justify-center flex-wrap transition-all duration-700 delay-300 ${
              ctaInView
                ? "opacity-100 translate-y-0"
                : "opacity-0 translate-y-5"
            }`}
          ...
          <div className="flex flex-col sm:flex-row items-start justify-between gap-8 mb-10">
            <div>
              ...
              <p className="text-slate-500 text-xs max-w-xs leading-relaxed">
                ...
                listings, and a home you&apos;ll love.
              </p>
            </div>
              ...
              <div className="flex flex-col gap-2">
                ...
                {["Browse PGs", "How it Works", "Features"].map((l) => (
                  <a
                    key={l}
                    href="#"
                    className="text-slate-500 hover:text-blue-400 text-xs transition-colors font-medium"
                  >
                    {l}
                  </a>
                ))}
